...
## Visual Storyboard - Episode 1

---

## SCENE 01: COLD OPEN - THE ESPRESSO

### Panel 1.1
**Shot Type:** EXTREME CLOSE-UP
**Duration:** 3 sec
**Description:** Steaming espresso dripping from machine into small cup
**Sound:** Espresso machine gurgling, dripping
**Camera Move:** Static

### Panel 1.2
**Shot Type:** CLOSE-UP - HANDS
**Duration:** 2 sec
**Description:** Large hands with gray hair pick up the cup
**Sound:** Cup clink
**Notes:** Show character detail - chunky silver ring, weathered skin
...
### Panel 1.4
**Shot Type:** WIDE - KITCHEN
**Duration:** 3 sec
**Description:** Ryan takes a sip, grimaces with pleasure
**Sound:** Satisfied grunt
**Character Animation:** Eyes roll back in caffeine bliss

---

## SCENE 02: THE FARMHOUSE EXTERIOR

### Panel 2.1
**Shot Type:** WIDE ESTABLISHING
**Duration:** 5 sec
**Description:** White Dutch farmhouse with red roof, canal in foreground, wind turbines in background
**Sound:** Birds chirping, breeze
...
**Sound:** Electronic hums, fan noise
**Key Elements:**
- Triple monitor setup (center)
- SSTV terminal with static (left)
- Server rack with blinking LEDs (back)
...
**Shots in montage:**
1. Email being deleted (spam, spam, spam)
2. Code scrolling on screen
3. Coffee cup being drained
4. Clock showing time passing (10am → 2pm → 4pm)
**Sound:** Typing sounds, occasional muttering
...
**Sound:** Electronic warble intensifies
**Animation:** Lines appearing one by one

### Panel 4.5
**Shot Type:** MEDIUM - RYAN WORKING
**Duration:** 4 sec
**Description:** Ryan grabs notebook, starts translating
**Sound:** Pen scratching
**Character Animation:** Leaning forward, intense focus
**Dialogue:** "That's a frequency. A military frequency."
...
**Dialogue:** "But why ROT1? A child could crack this..."
**Character Animation:** Scratching beard thoughtfully
...
**Sound:** Slow warbling (SSTV decode sound)
...
**Dialogue:** "Five hours. Time to pack for potential murder. Probably both."
**Character Animation:** Nervous but excited grin
...
**Dialogue:** "Dead man's switch. 12 hours."
**Notes:** Green text on black terminal
...
**Dialogue:** "Locked. Locked. Also locked."
**Character Animation:** Defeated body language
...
**Dialogue:** "This isn't just a weapons project. Someone's been infiltrated."
...
### Color Palette
- **Ryan's world:** Warm oranges, soft yellows (cozy but cluttered)
- **Mancave:** Green LED glow, blue screen light
- **Klooster night:** Dark blues, silver moonlight
- **Threat elements:** Red accents (warning text, USB tape)

### Animation Style (South Park Reference)
- Simple cutout animation
- Limited facial expressions (but very expressive)
- Minimal movement, character pops between poses
- Walking = bobbing up and down
- Objects snap into place rather than smooth transitions

### Sound Design
- **Mancave ambient:** Electronic hums, fan noise, occasional beep
- **Outdoor:** Dutch countryside - birds, distant boats, wind
- **Tension:** Low synth drone, heartbeat
- **Tech moments:** Retro computer sounds (beeps, dial-up callbacks)
