...
window.MancaveEvaContact = (function () {
    ...
    const EVA_MESSAGES = [
        ...
        { from: 'EVA_W', text: 'I scanned for technical targets near the facility. Found your SSTV terminal. Your equipment. I knew you could receive. And I knew you\'d understand.', timestamp: '03:19' },
        { from: 'Ryan', text: 'What do you need me to do?', timestamp: '03:20' },
        { from: 'EVA_W', text: 'There\'s a secure server room. Isolated network. Where they keep the real operational plans. Deployment schedules. Target coordinates. Direct evidence of FSB control.', timestamp: '03:21' },
        { from: 'EVA_W', text: 'I can get you inside. Night shift. Minimal security. But you\'ll need to bypass biometric locks and access the air-gapped server.', timestamp: '03:22' },
        { from: 'EVA_W', text: 'Get that data. We expose EVERYTHING. BND can\'t ignore hard evidence. NATO gets involved. This ends.', timestamp: '03:23' },
        { from: 'Ryan', text: 'When?', timestamp: '03:24' },
        { from: 'EVA_W', text: 'Tomorrow night. 11 PM. North entrance. I\'ll leave a badge for you. From there, you\'re on your own until you reach the server room. Then I can guide you remotely.', timestamp: '03:25' },
        { from: 'EVA_W', text: 'This is dangerous, Ryan. If they catch you, I can\'t help. If Volkov finds out... we both disappear.', timestamp: '03:26' },
        { from: 'Ryan', text: 'I\'m in. For your father. For everyone they\'ve hurt.', timestamp: '03:27' },
        { from: 'EVA_W', text: 'Thank you. Tomorrow night. Be ready. Stay off the grid until then. Meshtastic only. They monitor everything else.', timestamp: '03:28' },
        { from: 'EVA_W', text: 'Good luck, Ryan. The world needs hackers like you. Now more than ever.', timestamp: '03:29' }
    ];
                    ...
                    MC.schedule(() => {
                        ...
                        MC.schedule(() => {
                            ...
                            MC.revealDialogue(departDiv, [
                                ...
                                { speaker: '', text: '*That evening, 10:45 PM*' },
